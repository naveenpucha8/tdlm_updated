...
k=10 #k
word_embedding_size=50 #e; setting ignored if word_embeding_model is provided
...
#input/output
output_dir="output"
train_corpus="data1/toy-train.txt"
...
valid_corpus="data1/toy-valid.txt"
