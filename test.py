...
pad_symbol, start_symbol, end_symbol = cf.dummy_symbols[0], cf.dummy_symbols[1], cf.dummy_symbols[2]
vocabxid = dict([(y,x) for x,y in enumerate(idxvocab)])

# input_doc similar to corpus in train
sents, docs, docids, stats = gen_data(vocabxid, cf.dummy_symbols, tm_ignore, input_doc)
